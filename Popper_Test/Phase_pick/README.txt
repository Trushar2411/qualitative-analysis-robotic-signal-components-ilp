...
Important
---------
The phase column is used only for creating pos/neg labels.
There is deliberately no phase(sN,pick) fact in bk.pl.
Otherwise Popper could learn the trivial leakage rule:
