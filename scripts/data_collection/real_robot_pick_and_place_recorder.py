...
PICK_POSITION = [0, 39, -60, 0, -67, 0]
LIFT_POSITION = [-22, 25, -72, 0, -45, 0]
PLACE_POSITION = [-15, 46, -68, 0, -69, 0]
...
class Jessie:
    ...
    def set_gripper(self, phase_name, name, position, delay=1):
    ...
    def pick_and_place(self):
        ...
        try:
            ...
            self.set_gripper("gripper_opening", "Opening gripper", GRIPPER_OPEN)

            self.move_to("pick", PICK_POSITION, delay=3)

            self.set_gripper("gripper_closing", "Closing gripper", GRIPPER_CLOSE)
            ...
            self.move_to("return_home", HOME_POSITION)
    ...
    def convert_bag_to_csv(self):
        ...
        df["phase"] = df["phase"].bfill().ffill().fillna("home")
